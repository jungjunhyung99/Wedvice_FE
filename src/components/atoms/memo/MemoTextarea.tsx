...
const createTempSpan = (context: HTMLTextAreaElement , newValue:string): HTMLSpanElement => {
...
({
    ...
    const handleChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
        ...
        const calculatedWidth = Math.min(tempSpan.offsetWidth + TEXTAREA_PADDING, maxWidth);
        ...
        const newHeight = calculateNewHeight(calculatedWidth, textHeight, maxTextHeight, size);
    ...
    return (
        <textarea
            ...
            whiteSpace: dimensions.width >= SIZE_CONFIG[size].maxWidth ? 'pre-wrap' : 'nowrap',
            }}
            {...props}
        />
    );
